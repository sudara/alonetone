...
admin = User.create(:login => 'admin', :email => "123@123.com", :crypted_password => 'testing123')
admin.update_attribute(:admin, true)

moderator = User.create(:login => 'moderator', :email =>'mod@mod.com', :crypted_password => 'mod123')
moderator.update_attribute(:moderator, true)

musician = User.create(:login => 'musician', :email =>'music@music.com', :crypted_password => 'music123')
