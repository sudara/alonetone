...
I18n.translate('activerecord.errors.messages')[:inclusion] = "supposedly wasn't a real mp3 or zip file of mp3s. If you are sure it *was* an mp3 and you think we are crazy (half true anyway), try another browser to confirm. You can also email sudara@alonetone.com and yell at him. Apologies for ze troubles."
