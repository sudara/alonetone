...
xml.rss "xmlns:itunes"=> "http://www.itunes.com/dtds/podcast-1.0.dtd", "version"=>"2.0" do
  xml.channel do 
    xml.title  "Latest uploaded mp3s from artists at alonetone.com"
    
    xml.link  "http://alonetone.com/"
    xml.description  "The artists on alonetone.com give away their music. Listen to the lastest by subscribing"
    xml.language  "en-us"
    xml.lastBuildDate  rss_date @assets.first.created_at
    
    xml.image do
      xml.url  "http://www.alonetone.com/images/no-cover-200.jpg"
      xml.title  "Latest uploaded mp3s from artists at alonetone.com"
      xml.width 200
      xml.height 200
    end
