...
class AssetsController < ApplicationController  
  ...
  @@valid_listeners = ['msie','webkit','gecko','mozilla','netscape','itunes','chrome','opera', 'safari','cfnetwork','facebookexternalhit']
  ...
  def latest
    respond_to do |wants|
      wants.html do
        ...
        @comments = Comment.public.find(:all, :limit => 5) unless admin?
        @comments = Comment.include_private.find(:all, :limit => 5) if admin?        
