...
export default class extends Controller {
  static targets = ['image', 'imageLink', 'title', 'artist', 'time', 'waveform', 'waveformPoints', 'waveformReveal', 'progress', 'seekBar']
  ...
  timeUpdate(event) {
    ...
    if (duration && this.timeline.duration() !== duration) this.timeline.duration(duration)
